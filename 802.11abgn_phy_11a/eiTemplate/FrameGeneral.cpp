...
IMPLEMENT_DYNAMIC(CFrameGeneral, CDialog)

CFrameGeneral::CFrameGeneral(CWnd* pParent /*=NULL*/)
	: CDialog(CFrameGeneral::IDD, pParent)
{
	frametype = General;
}
...
void CFrameGeneral::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CFrameGeneral, CDialog)
END_MESSAGE_MAP()


// CFrameGeneral 消息处理程序


BOOL CFrameGeneral::OnInitDialog()
{
