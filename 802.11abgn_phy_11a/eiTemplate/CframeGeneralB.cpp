...
IMPLEMENT_DYNAMIC(CframeGeneralB, CDialogEx)

CframeGeneralB::CframeGeneralB(CWnd* pParent /*=NULL*/)
	: CDialogEx(CframeGeneralB::IDD, pParent)
{

}

CframeGeneralB::~CframeGeneralB()
{
}

void CframeGeneralB::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}


BEGIN_MESSAGE_MAP(CframeGeneralB, CDialogEx)
END_MESSAGE_MAP()


// CframeGeneralB 消息处理程序


BOOL CframeGeneralB::OnInitDialog()
{
