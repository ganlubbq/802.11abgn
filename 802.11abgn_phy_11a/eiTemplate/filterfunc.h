#ifndef _FILTERFUNC_H_
#define _FILTERFUNC_H_
...
vector<double> root_raised_cosine(double alpha,int ntaps,int oversample_ratio)
{
	double gain =1.0;
	ntaps |= 1;	// ensure that ntaps is odd
	double spb =  oversample_ratio; // samples per bit/symbol
